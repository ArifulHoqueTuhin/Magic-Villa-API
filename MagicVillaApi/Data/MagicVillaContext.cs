...
#warning 
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<VillaNumber>(entity =>
        {
            entity.HasKey(e => e.Id); // ✅ Make Id the primary key
            ...
            entity.Property(e => e.VillaNo)
                .HasColumnName("Villa_No")
                .ValueGeneratedNever(); // ✅ Not identity, manually set
            ...
            entity.Property(e => e.VillaId)
                .HasColumnName("Villa_Id");

            entity.HasOne(d => d.Villa)
                .WithMany(p => p.VillaNumbers)
                .HasForeignKey(d => d.VillaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Villa Number_VillaList");
        });
